...
#${dto.cat_variety}:hover {opacity: 0.7;}
...
<header class="site-header">
    ...
    <div class="introduce">
    	<ul>
			<li>
	            <img id="${dto.cat_variety }" src="${dto.cat_src }" alt="${dto.cat_variety}<br/><br/>
	            ${dto.cat_weight}<br/><br/>${dto.cat_furcolor}<br/><br/>${dto.cat_furtype}<br/><br/>${dto.cat_character}" width="300" height="200">
	        </li>
		</ul>
    </div>
    <!-- The Modal -->
    ...
    <script>
		...
		var img = document.getElementById('${dto.cat_variety }');
